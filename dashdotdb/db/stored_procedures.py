...
DROP FUNCTION IF EXISTS get_vulnerabilities(cluster_name text,
                                            namespace_name text);
DROP FUNCTION IF EXISTS get_severity_count(cluster_name text,
                                           namespace_name text,
                                           severity_name text);
"""

VULNERABILITIES_CREATE = """
CREATE OR REPLACE FUNCTION get_vulnerabilities(cluster_name text,
                                               namespace_name text)
...
CREATE OR REPLACE FUNCTION get_severity_count(cluster_name text,
                                              namespace_name text,
                                              severity_name text)
